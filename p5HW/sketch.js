...
var font = 'Georgia';
var letters = 'Words bounce. Words, if you let them, will do what they want to do and what they have to do.';
var fontSizeMin = 3;
...
function mousePressed() {
  x = mouseX;
  y = mouseY;
  // randomize voice and speak words:
  myVoice.setVoice(Math.floor(random(myVoice.voices.length)));
  myVoice.speak(letters);
  myVoice.interrupt = true;
  myVoice.setRate(random(20) / 10);
  myVoice.setPitch(random(20) / 10);
